export const CATEGORIES = [
  { id:"airway", name:"Airway & Ventilation", icon:"◉", items:[
    ["Nasal cannula (adult)",3],["Nasal cannula (paed)",3],["High flow mask (adult)",3],["High flow mask (paed)",3],["Nebulizer mask (adult)",3],["Nebulizer mask (paed)",3],["Oropharyngeal airway",5],["Nasopharyngeal airway",2],["Bag Valve Mask (adult)",1],["Bag Valve Mask (paed)",1],["BVM tubing",1],["BVM mask (adult)",2],["BVM mask (paed)",2],["Endotracheal tube size 7.0mm",2],["Endotracheal tube size 7.5mm",2],["Endotracheal tube size 8.0mm",2],["Endotracheal tube size 5.0mm",2],["Endotracheal tube size 5.5mm",2],["Endotracheal tube size 6.0mm",2],["Stylet (adult)",1],["Stylet (paed)",1],["Laryngeal mask airway size 2",2],["Laryngeal mask airway size 3",2],["Laryngeal mask airway size 4",2],["Laryngoscope handle",1],["Laryngoscope blade size 2",1],["Laryngoscope blade size 3",1],["Laryngoscope blade size 4",1],["Lubrication gel",1],["Anchor tape",1],["10cc Syringe",2]
  ]},
  ...
  { id:"drip", name:"IV Drip", icon:"滴", items:[
    ["Normal saline 0.9%",1],["Dextrose 10%",1],["Drip set tubing (adult)",1],["Microdrip chamber (paed)",1]
  ]},
  ...
  { id:"wound", name:"Wound Management", icon:"✥", items:[
    ["Adhesive tape / micropore (roll)",1],["Gauze pack",5],["Cotton pack",5],["Gamgee pack",3],["Arm sling",4],["Crepe bandage 10cm (roll)",3],["Crepe bandage 6cm (roll)",3],["Compression bandage",2],["Haemostatic bandage",2],["Commercial tourniquet",1],["Burnshield dressing kit",1]
  ]},
  { id:"personal", name:"Personal Equipment", icon:"▣", items:[
    ["Rescue scissor",1],["Torchlight",1],["Stethoscope",1],["Sterile glove",3],["Chest leads",15],["Spider strapping",1],["Goggles",3]
  ]}
];
